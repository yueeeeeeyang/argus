...
pub(crate) const SOURCE_PANEL_DEFAULT_WIDTH: f32 = 350.0;
...
pub(crate) const SEARCH_RESULT_PANEL_MIN_LOG_VIEW_HEIGHT: f32 = 60.0;
...
pub(crate) const SEARCH_RESULT_PANEL_RESERVED_HEIGHT: f32 =
    TITLE_BAR_HEIGHT + SEARCH_RESULT_PANEL_MIN_LOG_VIEW_HEIGHT;
/// 日志正文左侧内边距；命中测试和渲染必须保持一致。
pub(crate) const LOG_VIEWER_TEXT_LEFT_PADDING: f32 = 16.0;
/// 日志正文右侧内边距；横向滚动范围和渲染必须保持一致。
pub(crate) const LOG_VIEWER_TEXT_RIGHT_PADDING: f32 = 16.0;
/// Jstack 线程详情窗口默认宽度。
pub(crate) const JSTACK_THREAD_DETAIL_WINDOW_WIDTH: f32 = 900.0;
/// Jstack 线程详情窗口默认高度。
pub(crate) const JSTACK_THREAD_DETAIL_WINDOW_HEIGHT: f32 = 640.0;
/// Jstack 线程详情窗口最小宽度。
pub(crate) const JSTACK_THREAD_DETAIL_WINDOW_MIN_WIDTH: f32 = 600.0;
/// Jstack 线程详情窗口最小高度。
pub(crate) const JSTACK_THREAD_DETAIL_WINDOW_MIN_HEIGHT: f32 = 420.0;
/// 远程文件预览窗口默认宽度。
pub(crate) const FILE_PREVIEW_WINDOW_WIDTH: f32 = 920.0;
/// 远程文件预览窗口默认高度。
pub(crate) const FILE_PREVIEW_WINDOW_HEIGHT: f32 = 640.0;
/// 远程文件预览窗口最小宽度。
pub(crate) const FILE_PREVIEW_WINDOW_MIN_WIDTH: f32 = 600.0;
/// 远程文件预览窗口最小高度。
pub(crate) const FILE_PREVIEW_WINDOW_MIN_HEIGHT: f32 = 420.0;
/// 日志正文固定行高；分页滚动和 UI 渲染必须保持一致。
pub(crate) const LOG_VIEWER_ROW_HEIGHT: f32 = 20.0;
/// 行号栏最小宽度，保证小文件也有稳定的视觉留白。
pub(crate) const LOG_VIEWER_LINE_NUMBER_MIN_WIDTH: f32 = 44.0;
/// 行号栏最大宽度，避免超大文件行号挤占正文区域。
pub(crate) const LOG_VIEWER_LINE_NUMBER_MAX_WIDTH: f32 = 96.0;
/// 行号栏单个数字的估算宽度，用于无布局测量时的稳定宽度计算。
pub(crate) const LOG_VIEWER_LINE_NUMBER_DIGIT_WIDTH: f32 = 7.0;
...
pub(crate) const RUNTIME_SQL_COLLAPSED_ROW_HEIGHT: f32 = 36.0;
