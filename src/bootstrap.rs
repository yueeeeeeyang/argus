//! 文件职责：封装 Argus 桌面客户端的内部启动编排。
//! 创建日期：2026-06-09
//! 修改日期：2026-07-15
//! 作者：Argus 开发团队
//! 主要功能：初始化 GPUI 应用、打开主窗口、启动升级检查并处理应用重新打开和系统外部打开事件。

use crate::app::{ArgusApp, ExternalSourceTrigger};
use crate::assets::ArgusAssetSource;
use crate::fonts::register_argus_fonts;
use crate::platform::custom_titlebar as native_titlebar;
use crate::platform::external_sources::{paths_from_open_urls, paths_from_startup_args};
use crate::ui::custom_title_bar::{NATIVE_TRAFFIC_LIGHT_SAFE_WIDTH, TITLE_BAR_HEIGHT};
use gpui::{
